...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This is the model used to manage billable users. If you changed the
    | namespace or class name of your User model, update this here so
    | that Cashier knows where to locate your billable model.
    |
    */
